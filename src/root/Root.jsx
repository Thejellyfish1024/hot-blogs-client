    ...
    return (
        <div className="drawer ">
            ...
            <div className="drawer-content flex flex-col">
                {/* Navbar */}
                <div className="w-full p-5 navbar bg-base-300">
                    ...
                    <div className="flex max-w-7xl mx-auto justify-between w-full">
                        <div className="flex flex-col md:flex-row items-center">
                            <img src="https://w7.pngwing.com/pngs/204/418/png-transparent-social-media-blogger-computer-icons-logo-blog-text-rectangle-orange-thumbnail.png" className="w-10 h-10 md:w-12 md:h-12" alt="" />
